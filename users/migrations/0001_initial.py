    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reputation', models.FloatField(default=5.0, help_text="User's reputation based on the continuos visits.")),
                ('musiclists', models.ManyToManyField(through='users.MusicListInProfile', to='laramusicAPI.MusicList')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': 'created',
